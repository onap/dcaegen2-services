...
public class SnssaiSamplesProcessorTest {
    ...
    public void setup() {
        ...
        try {
            ricToPrbsMapping =
                    obj.readValue(new String(Files.readAllBytes(Paths.get("src/test/resources/ricToPrbMap.json"))),
            ...
            ricToCellMapping =
                    obj.readValue(new String(Files.readAllBytes(Paths.get("src/test/resources/ricToCellMapping.json"))),
    ...
    public void calculatePercentageChangeTest() {
        ...
        try {
            ricConfiguration =
                    obj.readValue(new String(Files.readAllBytes(Paths.get("src/test/resources/ricConfiguration.json"))),
    ...
    public void sumOfPrbsAcrossCellsTest() {
        ...
        try {
            ricToPrbsMappingExp =
                    obj.readValue(new String(Files.readAllBytes(Paths.get("src/test/resources/ricToPrbOutput.json"))),
                            new TypeReference<Map<String, Map<String, Integer>>>() {});
        } catch (IOException e) {
            e.printStackTrace();
        }
