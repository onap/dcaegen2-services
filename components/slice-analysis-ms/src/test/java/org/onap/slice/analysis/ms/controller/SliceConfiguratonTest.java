...
public class SliceConfiguratonTest {
    ...
    private static Logger log = LoggerFactory.getLogger(SliceConfiguratonTest.class);
    ...
    public void getSnssaiListTest() throws Exception {
        ...
        log.info("sliceConfigResquestString: " + objectMapper.writeValueAsString(sliceConfigRequest));
        ...
        log.info("sliceConfigResquestString: " + sliceConfigResquestString);
        log.info("sliceConfigResponseString: " + objectMapper.writeValueAsString(sliceConfigResponse));
