...
public class AdditionalProperties {
	...
	private Map<String, Map<String, Integer>> resourceConfig;
	...
	public Map<String, Map<String, Integer>> getResourceConfig() {
		return resourceConfig;
	}
	public void setResourceConfig(Map<String, Map<String, Integer>> resourceConfig) {
