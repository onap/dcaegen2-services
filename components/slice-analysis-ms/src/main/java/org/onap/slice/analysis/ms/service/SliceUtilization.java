...
public class SliceUtilization {
    ...
    private static final Integer totalPRB = 132;
    ...
    protected AggregatedConfig calculateSliceUtilization(List<JSONObject> pmDataList) {
        ...
        Integer averageDLThptPerSlice = dlPRBUsed / numOfPRBData;
        Integer averageULThptPerSlice = ulPRBUsed / numOfPRBData;
        AggregatedConfig aggregatedConfig = new AggregatedConfig();
        aggregatedConfig.setDLThptPerSlice(totalPRB - averageDLThptPerSlice);
        aggregatedConfig.setULThptPerSlice(totalPRB - averageULThptPerSlice);
