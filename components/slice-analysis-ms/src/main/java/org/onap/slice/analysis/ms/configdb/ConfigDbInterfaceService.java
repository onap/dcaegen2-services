...
public class ConfigDbInterfaceService implements IConfigDbService {
    ...
    public Map<String, Integer> fetchCurrentConfigurationOfSlice(String snssai) {
        ...
        ResponseEntity<Map<String, Integer>> response =
                restclient.sendGetRequest(reqUrl, new ParameterizedTypeReference<Map<String, Integer>>() {});
    ...
    public List<String> fetchNetworkFunctionsOfSnssai(String snssai) {
        ...
        ResponseEntity<List<NetworkFunctionModel>> response =
                restclient.sendGetRequest(reqUrl, new ParameterizedTypeReference<List<NetworkFunctionModel>>() {});
    ...
    public Map<String, List<String>> fetchRICsOfSnssai(String snssai) {
        ...
        ResponseEntity<Map<String, List<CellsModel>>> response =
                restclient.sendGetRequest(reqUrl, new ParameterizedTypeReference<Map<String, List<CellsModel>>>() {});
    ...
    public Map<String, String> fetchServiceDetails(String snssai) {
        ...
        ResponseEntity<Map<String, String>> response =
                restclient.sendGetRequest(reqUrl, new ParameterizedTypeReference<Map<String, String>>() {});
