...
public class KpiComputeReceiver {

    /**
     * The method to handle data.
     * 
     * @param kpi kpi
     * @param methodForKpi methodForKpi
     * @param pmEvent pmEvent
     * @param keyOperands keyOperands
     * @param kpiOperands kpiOperands
     * @return VesEvent VesEvent
     */
    public String kpiOperation(Kpi kpi, MethodForKpi methodForKpi,
                              PerformanceEvent pmEvent, String keyOperands, List<BigDecimal> kpiOperands) {
        // Create ves kpi data
        ...
        tmpMeasDataCollection
                .setMeasuredEntityDn(pmEvent.getPerf3gppFields()
        ...
        measInfoId.setMeasInfoId(methodForKpi.getControlLoopSchemaType().toString());
        MeasTypes measTypes = new MeasTypes();
        List<String> measTypesList = new ArrayList<>();
        measTypesList.add(new StringBuilder().append(kpi.getMeasType()).append(keyOperands).toString());
        ...
        return VesJsonConversion.convertVesEventToString(kpiVesEvent);
    }
}
