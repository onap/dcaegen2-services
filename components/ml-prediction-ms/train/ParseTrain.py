...
def Parser(cells_data_list,data_dic,features): 
    ...
    try:
        ...
        for cells_data in cells_data_list: 
            ...
            response = requests.get(pathToGetConfigData + cell_id + '/snssai/01-B989BD') 
...
def GetSlicesCellsData():
    ...
    try:
        ...
        response = requests.post(pathToStartPMData, verify=False ,auth=('dcae@dcae.onap.org', 'demo123456!')) 
        print(response)
    except Exception as e:
    ...
    try:
        ...
        response = requests.post(pathToStopPMData, verify=False ,auth=('dcae@dcae.onap.org', 'demo123456!')) 
        print(response)
    except Exception as e:
...
def ProcessSlicesCellsData():
    ...
    try:
        ...
        while True: 
            response = requests.get(pathToGetData, verify=False ,auth=('dcae@dcae.onap.org', 'demo123456!')) 
            data = response.json() 
            print(data) 
