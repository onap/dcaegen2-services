...
public class DmaapPublisherTaskImpl implements DmaapPublisherTask {
    ...
    @Autowired
    public DmaapPublisherTaskImpl(ApplicationConfiguration configuration) {
        this(configuration, new PublisherReactiveHttpClientFactory(new DmaaPRestTemplateFactory(), new ControlLoopJsonBodyBuilder()));
    }

    DmaapPublisherTaskImpl(ApplicationConfiguration configuration, PublisherReactiveHttpClientFactory httpClientFactory) {
