...
public class ApplicationConfiguration implements ConfigurationChangeObservable {
    ...
    public int getPipelinesPollingIntervalInSeconds() { return genericProperties.getPipelinesPollingIntervalSec(); }

    public int getPipelinesTimeoutInSeconds() { return genericProperties.getPipelinesTimeoutSec(); }
