...
class NetworkFunctionSubscriptionTests(unittest.TestCase):
    ...
    def test_get_nfs_per_subscription(self):
        ...
        nf_subscription.add_network_functions_per_subscription('sub1', 'active', nf_array)
        nf_subscription.add_network_functions_per_subscription('sub2', 'active', nf_array)
    ...
    def test_add_network_functions_per_subscription(self):
        ...
        nf_subscription.add_network_functions_per_subscription('sub1', 'active', new_nf_array)
        nf_subs = nf_subscription.get_nfs_per_subscription('sub1')
    ...
    def test_add_duplicate_network_functions_per_subscription(self):
        ...
        nf_subscription.add_network_functions_per_subscription(sub_name, 'active', nf_array)
