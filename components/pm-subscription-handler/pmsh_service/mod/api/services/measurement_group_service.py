...
def create_measurement_group(subscription, measurement_group_name, body):
    ...
    Args:
        ...
        body (MeasurementGroupModel): measurement group request body to save.
    ...
    if body.administrative_state == AdministrativeState.UNLOCKED:
        ...
        logger.info(f'Measurement Group {measurement_group_name} is not in unlocked state')
...
def save_measurement_group(measurement_group, subscription_name):
    ...
    if not isinstance(measurement_group, MeasurementGroupModel):
