...
def create_measurement_group(subscription, measurement_group_name, body):
    ...
    unlocked_mgs = subscription_service.get_unlocked_measurement_grps(subscription)
    subscription_service.add_new_filtered_nfs(filtered_nfs, unlocked_mgs, subscription)
