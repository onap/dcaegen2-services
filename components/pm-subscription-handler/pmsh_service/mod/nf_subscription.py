...
def add_network_functions_to_subscription(subscription_name, subscription_status, nf_list):
    ...
    logger.debug(f'Adding network functions to subscription {subscription_name}')
