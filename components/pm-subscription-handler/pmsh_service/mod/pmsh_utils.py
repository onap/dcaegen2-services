...
class _MrPub(_DmaapMrClient):
    ...
    def publish_subscription_event_data(self, subscription, xnf, app_conf):
        """
        ...
        Args:
            ...
            xnf (NetworkFunction): the NetworkFunction to include in the event.
            app_conf (AppConfig): the application configuration.
        """
        try:
            subscription_event = subscription.prepare_subscription_event(xnf, app_conf)
