...
class NetworkFunction:
    ...
    @classmethod
    def nf_def(cls):
        return cls(nf_name=None, ipv4_address=None, ipv6_address=None, model_invariant_id=None,
    ...
    def __hash__(self):
        return hash((self.nf_name, self.ipv4_address, self.ipv6_address, self.model_invariant_id,
