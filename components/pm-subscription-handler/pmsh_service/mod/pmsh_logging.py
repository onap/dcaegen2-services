...
def create_loggers():
    ...
    """
    makedirs("/opt/app/pmsh/logs", exist_ok=True)

    # create the audit log
    aud_file = "/opt/app/pmsh/logs/audit.log"
    open(aud_file, "a").close()  # this is like "touch"
    global _AUDIT_LOGGER
    _AUDIT_LOGGER = _create_logger("pmsh_service_audit", aud_file)

    # create the error log
    err_file = "/opt/app/pmsh/logs/error.log"
    ...
    met_file = "/opt/app/pmsh/logs/metrics.log"
    ...
    debug_file = "/opt/app/pmsh/logs/debug.log"
