...
INSERT INTO kafka(
  ...
  1
  ,'main Kafka cluster' -- SQLINES DEMO *** (255)
  ,3   -- SQLINES DEMO *** IN int(11)
  ,B'1'   -- enabled - IN bit(1)
  ,'dlgroup'  -- SQLINES DEMO *** r(255)
  ,'message-router-kafka:9092'  -- SQLINES DEMO *** rchar(255)
  ,''  -- SQLINES DEMO *** IN varchar(255)
  ,'admin'  -- SQLINES DEMO *** r(255)
  ,'admin_secret'  -- SQLINES DEMO *** (255)
  ,B'0'   -- secure - IN bit(1)
  ,'SASL_PLAINTEXT'  -- SQLINES DEMO ***  - IN varchar(255)
  ,10   -- SQLINES DEMO *** int(11)
  ,'message-router-zookeeper:2181'  -- SQLINES DEMO *** 55)
);
...
insert into db_type (id, name, tool) values ('HDFS', 'HDFS', B'1');
...
insert into db (id, db_type_id, enabled, encrypt, name,host,port,database_name) values (3, 'MONGO', B'1', B'1', 'MongoDB 1','dl-mongodb',27017,'datalake');
