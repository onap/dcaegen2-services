...
@Component({
  selector: 'app-edit-mongodb',
  templateUrl: './edit-mongodb.component.html',
  styleUrls: ['./edit-mongodb.component.css']
})
export class EditMongodbComponent implements OnInit {
