...
@Component({
  selector: 'app-edit-couchbase',
  templateUrl: './edit-couchbase.component.html',
  styleUrls: ['./edit-couchbase.component.css']
})
export class EditCouchbaseComponent implements OnInit {
