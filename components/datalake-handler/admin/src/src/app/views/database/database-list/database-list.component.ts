...
import {EditDruidComponent} from "src/app/views/database/database-list/dbs-modal/druid/edit-druid/edit-druid.component";
import {EditCouchbaseComponent} from "src/app/views/database/database-list/dbs-modal/couchbase/edit-couchbase/edit-couchbase.component";
import {EditElasticsearchComponent} from "src/app/views/database/database-list/dbs-modal/elasticsearch/edit-elasticsearch/edit-elasticsearch.component";
import {EditMongodbComponent} from "src/app/views/database/database-list/dbs-modal/mongodb/edit-mongodb/edit-mongodb.component";
import {EditHdfsComponent} from "src/app/views/database/database-list/dbs-modal/hdfs/edit-hdfs/edit-hdfs.component";
...
export class DatabaseListComponent implements OnInit {
  ...
  getDbList(flag) {
    return this.dbApiService.getDbList(flag).toPromise();
  ...
  updateDbModel(id: number, dbType: string) {
    ...
    switch (dbType) {
      case "CB": {
        modalRef = this.modalService.open(EditCouchbaseComponent, {
          size: "lg",
          centered: true
        });
      ...
      case "DRUID": {
        modalRef = this.modalService.open(EditDruidComponent, {
          size: "lg",
          centered: true
        });
        this.editDbModal(id, modalRef);
      ...
      case "ES": {
        modalRef = this.modalService.open(EditElasticsearchComponent, {
          size: "lg",
          centered: true
        });
        this.editDbModal(id, modalRef);
      ...
      case "MONGO": {
        modalRef = this.modalService.open(EditMongodbComponent, {
          size: "lg",
          centered: true
        });
        this.editDbModal(id, modalRef);
      ...
      case "HDFS": {
        modalRef = this.modalService.open(EditHdfsComponent, {
          size: "lg",
          centered: true
        });
        this.editDbModal(id, modalRef);
