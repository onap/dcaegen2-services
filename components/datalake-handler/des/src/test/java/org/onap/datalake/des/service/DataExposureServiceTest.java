...
public class DataExposureServiceTest {
    ...
    public DataExposureConfig getDataExposureConfig() {
        ...
        deConfig.setSqlTemplate(
                "select event.commonEventHeader.sourceName as name, event.perf3gppFields.measDataCollection.measuredEntityDn as entity from datalake where event.commonEventHeader.sourceName = '${name}'");
        return deConfig;
    }
