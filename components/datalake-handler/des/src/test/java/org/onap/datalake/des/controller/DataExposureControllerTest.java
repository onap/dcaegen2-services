...
public class DataExposureControllerTest {
    ...
    public void testServe() throws IOException, NoSuchFieldException, IllegalAccessException, ClassNotFoundException, SQLException {
    	DataExposureController dataExposureController = new DataExposureController();
    	String serviceId = "test";
    	Map<String, String> requestMap = new HashMap<String,String>();
    	requestMap.put("name", "oteNB5309");
    	HashMap<String, Object> result = dataExposureController.serve(serviceId, requestMap, mockBindingResult, httpServletResponse);
